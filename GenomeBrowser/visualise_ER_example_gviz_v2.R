...
load(file = "/home_2/gsit/data/ERs_optimised_cut_off_max_gap_all_tissues_w_annot_df.rda")

tissue_optimal_cut_off_max_gap_df <- read_delim("/home_2/gsit/data/exon_delta_details_optimised_maxgap_cutoff.csv", delim = ",")

gtex_tissue_name_formatting <- read_delim("/home_2/gsit/data/OMIM_gtex_tissue_name_formatting.csv", delim = ",")

ensembl_gene_id_to_symbol_df_v92 <- read_delim("/home_2/gsit/data/ensembl_gene_id_to_symbol_df_v92.csv", delim = ",")

# Functions -------------------------------------------------------------------------------------------

##### First level #####

source("/home_2/gsit/data/generate_txDb_from_gtf.R")
source("/home_2/gsit/data/constraint_general_functions.R")
...
get_gtex_split_read_table_mean_cov_n_samples_df <- function(gtex_tissue_name_formatting){
  ...
  gtex_split_read_table_annotated_paths <- 
    list.files("/home_2/gsit/data/gtex_split_read_table_annotated_rda/", full.names = T)
...
source("/home_2/gsit/data/conservation_general_functions.R")
source("/home_2/gsit/data/query_biomart.R")
...
ensembl_grch38_v92_genes_txdb <- 
  generate_txDb_from_gtf(gtf_gff3_path = "/home_2/gsit/data/Homo_sapiens.GRCh38.92.gtf", 
                         output_path = "/home_2/gsit/data/ensembl_grch38_v92_txdb.sqlite",
                         seq_levels_to_keep = c(1:22, "X", "Y", "MT"), genome_build = "hg38")

aceview_hg38_txdb <- 
  generate_txDb_from_gtf(gtf_gff3_path = "/home_2/gsit/data/AceView.ncbi_37.genes_gff.gff", 
                         output_path = "/home_2/gsit/data/aceview_hg38_txdb.sqlite",
